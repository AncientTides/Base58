...
/*
LIST OF OPERATORS USABLE!!!

Arithmetic operators		-, *, /, %, 
Bitwise operators 	|, ^, <<, >>


How to make use of the BigInteger library

ASSUME int b = 535 and string push = "7429729474927377349024802840824820480740870984070940702927486723529359729764969402";
BigInteger a = 5;
BigInteger a = b;
BigInteger drat(a); - copies value of a to variable drat
BigInteger ber(-7274927498924); - automatically converts to BigInteger 
BigUnsigned var;
BigUnsigned(var);
BigUnsigned i(0xFF0000FF), j(0x0000FFFF); - handles hex data extremely well


List of BigInteger functions

toUnsignedLong() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toLong() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toUnsignedInt() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toInt() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toUnsignedShort() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toShort() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();
toInt() - convert BigInteger or BigUnsigned to int. USAGE:- a.toInt();


add(BigUnsigned a, BigUnsigned b)
subtract(BigUnsigned a, BigUnsigned b)
multiply(BigUnsigned a, BigUnsigned b)
bitAnd(BigUnsigned a, BigUnsigned b)
bitOr(BigUnsigned a, BigUnsigned b)
bitXor(BigUnsigned a, BigUnsigned b)
bitShiftLeft(BigUnsigned a, BigUnsigned b)
bitShiftRight(BigUnsigned a, BigUnsigned b)


add(BigInteger &a, BigInteger &b);
subtract(BigInteger &a, BigInteger &b);
multiply(BigInteger &a, BigInteger &b);
divideWithRemainder(BigInteger &a, BigInteger &b);
negate(BigInteger &a, BigInteger &b);

stringToBigInteger() - converts numeric or hex string to BigInteger . USAGE:- stringToBigInteger(a);
bigIntegerToString() - converts BigInteger to string . USAGE:- bigIntegerToString(a);


// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Some mathematical algorithms for big integers. This code is new and, as such, experimental.

BigUnsigned gcd(BigUnsigned a, BigUnsigned b); // Returns the greatest common divisor of a and b.

BigUnsigned modinv(const BigInteger &x, const BigUnsigned &n); // Returns the multiplicative inverse of x modulo n, or throws an exception if they have a common factor.

BigUnsigned modexp(const BigInteger &base, const BigUnsigned &exponent, const BigUnsigned &modulus); // Returns (base ^ exponent) % modulus.
 ...
 * Each put-here operation uses the DTRT_ALIASED_UNSIGNED macro (Do The Right Thing on
